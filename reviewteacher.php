...
<tbody>
  ...
  $sql = "SELECT * FROM teafeedback WHERE email='$smail'";
  $result = $conn->query($sql);

  if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
      $num++;
      $modalId = "exampleModalLong" . $num; 
  ?>
    <tr>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="<?php echo $modalId; ?>Title">Feedback Given By <?php echo "Anonymous Student" ?></h5>
